...
import { buildOrdersPdfExport, fetchOrdersForExport } from '@/lib/orders-export'
...
export async function GET(req: Request) {
  ...
  const result = await buildOrdersPdfExport(data.orders, data.truncated, data.maxRows, url.searchParams, currency)
