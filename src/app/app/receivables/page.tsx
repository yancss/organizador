...
type Receivable = {
  ...
  dueAt: string | null
  value: string | number
  applications: Array<{ id: string; value: string | number; appliedAt: string; payment: { id: string; method: string; status: string; receivedAt: string } }>
  createdAt: string
  updatedAt: string
}
  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-neutral-600">Contas a receber reais (por expedição). Pagamentos são aplicados automaticamente quando o recebível nasce.</p>
      </div>
